...
Replace the sequence {x}, {y} in the simple-minded phonetic transcription by {a}, {b} if
the item immediately before {x} were BEFORE and the ones immediately after {y} were AFTER
and the conditions hold. {x} is a mixture of properties of the written character and what
it sounds like.
